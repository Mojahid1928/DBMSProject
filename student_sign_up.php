...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO student (stu_name, email, mobile, course, address, date_of_birth, password) 
            ...
            <div class="col-md-6">
                <div class="card shadow-lg">
                    <div class="card-header text-center">
                        <h3><i class="bi bi-person-circle me-2"></i>Student Sign Up</h3>
                    </div>
                    <div class="card-body">
                        <?php if (isset($error)): ?>
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="mb-3">
                                <label for="course" class="form-label"><i class="bi bi-journal-bookmark-fill"></i> Course</label>
